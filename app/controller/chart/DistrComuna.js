Ext.define('Estratificacion.controller.chart.DistrComuna',{
	...
	models:['Estratificacion.model.Comuna',
			'Estratificacion.model.Grafico'	],
	stores:['Estratificacion.store.Comuna',
	...
	crearDistrEstrato:function(){
		...
		var distrEstrato=Ext.create('Estratificacion.view.chart.Estrato',{
				tbar:[
					'','Gr&aacutefico ',
					{xtype:'combobox', text: '&lt;',tooltip: 'Seleccionar Gr&aacutefico', width:90, store:gstore, queryMode:'local', 
					displayField:'nombre',valueField:'tipo', value:'column', name:'tipo', id:'tipo_g',itemId:'tipo_g',forceSelection : true, allowBlank:false, 
					triggerAction: 'all',anyMatch:true},
					'','-','','Estrato ',
					
					{xtype:'combobox', text: '&lt;',tooltip: 'Seleccionar Comuna', width:90, store:cstore, queryMode:'local', 
					displayField:'nombre',valueField:'cod_comuna', value:'1', name:'comuna', id:'v-comuna',itemId:'v-comuna',forceSelection : true, allowBlank:false, 
					triggerAction: 'all',anyMatch:true},
					
					'',{xtype:'button', text:'Generar', iconCls:'grafico', itemId:'btn-distrComuna'},
					'',	'-' ]
		});
	...
	genDistrGrafico:function(btn, e, eOpts){
				...
				var mascara = new Ext.LoadMask(Ext.getCmp('graficarea'), {msg:'Generando gr&aacutefico...'});
		        mascara.show();

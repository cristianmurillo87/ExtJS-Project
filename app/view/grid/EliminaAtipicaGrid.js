...
Ext.define('Estratificacion.view.grid.EliminaAtipicaGrid',{
	...
	columns:[
		...
		{text:"Terreno", dataIndex:'cod_predio', width:120},
		{text:"Direccion", dataIndex:'direccion', width:140},
		{text:"Tipo", dataIndex:'tipo_atip', width:40},
		{text:"Justificacion", dataIndex:'justificacion', width:250}
	],
	columnWidth:10,
	listeners:{
		itemclick:{
